...
I am an Assistant Professor in the [Department of Bio and Brain Engineering](https://bioeng.kaist.ac.kr/) at [KAIST](https://www.kaist.ac.kr/en/). My research projects use techniques in data science, applied statistics, and machine learning to interpret large collections of biomedical data. In collaboration with experimentalists, I also develop specific computational methods and algorithms to tackle fundamental questions in modern biology.
